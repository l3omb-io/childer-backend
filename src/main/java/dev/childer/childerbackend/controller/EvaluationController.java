...
public class EvaluationController {
    ...
    @PostMapping("")
    public @ResponseBody ResponseEntity<EvaluationModel> postEvaluation(@RequestBody EvaluationModel evaluation){
        return new ResponseEntity<>(this.evaluationService.saveEvaluation(evaluation),HttpStatus.CREATED);
    }
