...
//
//    @GetMapping("/{id}")
//    public @ResponseBody ResponseEntity<BookModel> getOneBook(@PathVariable Long id){
...
//
//    @PutMapping("/{id}")
//    public @ResponseBody ResponseEntity<BookModel> putBook(@PathVariable Long id,@RequestBody BookModel book){
